        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 text-center text-sm text-gray-600 space-y-1">
              <p><strong>Admin:</strong> admin@atlantasalon.com / password</p>
              <p><strong>Staff:</strong> staff@atlantasalon.com / password</p>
              <p><strong>Customer:</strong> customer@atlantasalon.com / password</p>
            </div>
          </div>
        </div>
      </div>
